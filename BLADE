...
local Window = Rayfield:CreateWindow({
   Name = "BLADE BAL ABIL TES",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "Abil Ganteng",
   LoadingSubtitle = "by abil uwu",
   ShowText = "jingkontod", -- for mobile users to unhide rayfield, change if you'd like
   ...
   KeySettings = {
      Title = "ABIL VIP BLADE BALL",
      Subtitle = "Key System",
      Note = "Key Minta Sma Babang Abil", -- Use this to tell the user how to get a key
      FileName = "ABIL", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"ABIL"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
