if shared.RiseMode then
    return loadstring(game:HttpGet('https://raw.githubusercontent.com/aaabiiil/abilmain/refs/heads/main/NewMainScript.lua'))()
end
...
commit = 'bb05577440115d457047615a0aa4014651f14afe'
